...
class ClassificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getClassifyPermissions = channel.unary_unary(
                '/plp.proto.ClassificationService/getClassifyPermissions',
                request_serializer=plp_dot_proto_dot_Classification__pb2.EmptyClassify.SerializeToString,
                response_deserializer=plp_dot_proto_dot_Classification__pb2.ClassifyPermissionResponse.FromString,
                )
...
def add_ClassificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getClassifyPermissions': grpc.unary_unary_rpc_method_handler(
                    servicer.getClassifyPermissions,
                    request_deserializer=plp_dot_proto_dot_Classification__pb2.EmptyClassify.FromString,
                    response_serializer=plp_dot_proto_dot_Classification__pb2.ClassifyPermissionResponse.SerializeToString,
            ),
    }
...
class ClassificationService(object):
    ...
    @staticmethod
    def getClassifyPermissions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/plp.proto.ClassificationService/getClassifyPermissions',
            plp_dot_proto_dot_Classification__pb2.EmptyClassify.SerializeToString,
            plp_dot_proto_dot_Classification__pb2.ClassifyPermissionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
