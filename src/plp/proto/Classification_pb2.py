...
_CLASSIFICATIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="plp.proto.ClassificationRequest.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="text",
            full_name="plp.proto.ClassificationRequest.text",
            index=1,
            number=10,
            type=9,
            cpp_type=9,
...
_CLASSIFICATIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="classifierName",
            full_name="plp.proto.ClassificationResponse.classifierName",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="classification",
            full_name="plp.proto.ClassificationResponse.classification",
            index=1,
            number=10,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="confidence",
            full_name="plp.proto.ClassificationResponse.confidence",
            index=2,
            number=20,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="extras",
            full_name="plp.proto.ClassificationResponse.extras",
            index=3,
            number=30,
            type=9,
            cpp_type=9,
...
_CLASSIFYPERMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="permission",
            full_name="plp.proto.ClassifyPermission.permission",
            index=0,
            number=40,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="description",
            full_name="plp.proto.ClassifyPermission.description",
            index=1,
            number=50,
            type=9,
            cpp_type=9,
...
_CLASSIFYPERMISSIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="permDetails",
            full_name="plp.proto.ClassifyPermissionResponse.permDetails",
            index=0,
            number=60,
            type=11,
            cpp_type=10,
...
_CLASSIFYPERMISSIONRESPONSE.fields_by_name[
    "permDetails"
].message_type = _CLASSIFYPERMISSION
...
] = _CLASSIFYPERMISSIONRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

EmptyClassify = _reflection.GeneratedProtocolMessageType(
    "EmptyClassify",
    (_message.Message,),
    {
...
ClassifyPermission = _reflection.GeneratedProtocolMessageType(
    "ClassifyPermission",
    (_message.Message,),
    {
...
ClassifyPermissionResponse = _reflection.GeneratedProtocolMessageType(
    "ClassifyPermissionResponse",
    (_message.Message,),
    {
